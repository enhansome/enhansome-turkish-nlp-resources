...
* [Yargı MCP](https://github.com/saidsurucu/yargi-mcp) ⭐ 1,096 | 🐛 1 | 🌐 Python | 📅 2026-08-06 : Search for Turkish Legal Databases (Yargıtay, Danıştay).
* [Borsa MCP](https://github.com/saidsurucu/borsa-mcp) ⭐ 638 | 🐛 1 | 🌐 Python | 📅 2026-08-07 : Istanbul Stock Exchange (BIST) and investment fund data.
* [Mevzuat MCP](https://github.com/saidsurucu/mevzuat-mcp) ⭐ 229 | 🐛 2 | 🌐 Python | 📅 2026-06-18 : Search Turkish Legislation (laws, regulations).
* [YÖK Tez MCP](https://github.com/saidsurucu/yoktez-mcp) ⭐ 124 | 🐛 0 | 🌐 Python | 📅 2026-05-20 : Turkish National Thesis Center (YÖK Tez) search.
* [YÖK Atlas MCP](https://github.com/saidsurucu/yokatlas-mcp) ⭐ 70 | 🐛 0 | 🌐 Python | 📅 2026-07-23 : YÖK Atlas higher education and ranking data.
...
* [Zemberek-NLP](https://github.com/ahmetaa/zemberek-nlp) ⭐ 1,349 | 🐛 56 | 🌐 Java | 📅 2026-04-28 (Java) : The veteran NLP library for Turkish (Morphology, Spell Check, etc.).
* [VNLP](https://github.com/vngrs-ai/vnlp) ⭐ 289 | 🐛 0 | 🌐 Python | 📅 2025-09-11 (Python) : State-of-the-art, lightweight NLP tools for Turkish.
...
* [Zemberek-Python](https://github.com/Loodos/zemberek-python) ⭐ 139 | 🐛 9 | 🌐 Python | 📅 2025-06-23 (Python) : Python wrapper/implementation of Zemberek.
