...
* [Yargı MCP](https://github.com/saidsurucu/yargi-mcp) ⭐ 1,106 | 🐛 3 | 🌐 Python | 📅 2026-08-06 : Search for Turkish Legal Databases (Yargıtay, Danıştay).
* [Borsa MCP](https://github.com/saidsurucu/borsa-mcp) ⭐ 642 | 🐛 4 | 🌐 Python | 📅 2026-08-07 : Istanbul Stock Exchange (BIST) and investment fund data.
